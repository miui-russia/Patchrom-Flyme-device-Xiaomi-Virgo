...
#-----------------------------------------------------------------------------
vendor_remove_dirs := media supersu
...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService Camera2 shutdownlistener Stk TimeService \
		     com.qualcomm.location qcrilmsgtunnel
...
override_property += \
    ...
    ro.product.model_romer=virgo_Po_Chan
